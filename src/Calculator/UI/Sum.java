...
public class Sum implements ActionListener {
    ...
    public Sum(Calculator calc,JTextField num1,JTextField num2,JLabel result){
        this.calc = calc;
        this.number1 = num1;
        this.number2 = num2;
        this.result = result;
    ...
    public void actionPerformed(ActionEvent ae){
        try {
            this.calc.sum(Double.parseDouble(number1.getText()),Double.parseDouble(number2.getText()));
